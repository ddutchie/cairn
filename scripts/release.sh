...
echo "GitHub Actions will now build the DMG/installers"
echo "and upload them as a DRAFT release."
echo ""
echo "After CI finishes:"
echo "  1. Download the DMG from:"
echo "     https://github.com/ddutchie/cairn/releases/tag/$NEW_VERSION"
echo "  2. Open it, click around, check the console for errors"
echo "  3. If everything looks good, promote the release:"
echo ""
echo "       ./scripts/promote-release.sh $NEW_VERSION"
echo ""
echo "  Auto-update will only pick up the release after promotion."
echo "------------------------------------------------"
