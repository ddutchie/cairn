...
run("esbuild electron/main.ts electron/preload.ts --bundle --platform=node --target=node20 --external:electron --external:better-sqlite3 --external:node-pty --outdir=dist-electron --format=cjs");
