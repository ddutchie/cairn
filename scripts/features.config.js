...
const FEATURES = [
  ...
  {
    id: "v2.7.0-responses-api",
    version: "v2.7.0",
    title: "OpenAI Responses API",
    category: "AI",
    description:
      "Cairn's AI layer now speaks the OpenAI Responses API — the wire format OpenAI and the Open Responses ecosystem are standardising on. Chat, the coding agent, and one-shot features route through /v1/responses whenever a provider supports it and fall back to Chat Completions otherwise, with condensed reasoning summaries in the Thinking panel.",
    highlights: [
      "Automatic Protocol Routing: Chat, the agent, one-shots, compaction, and subagents use /v1/responses when the provider supports it — with a cached capability check and automatic fallback to Chat Completions.",
      "Condensed Thought Summaries: The collapsed Thinking panel shows a concise summary of the model's reasoning instead of a truncated trace.",
  ...
  {
    id: "v2.7.5-chat-themes",
    version: "v2.7.5",
    title: "Chat Themes",
    category: "Appearance",
    description:
      "Re-skin the chat surface with full distinct looks — each theme bundles its own chat font, background treatment, bubble style, and a dark/light palette. More themes arrive from the community catalog, no app update needed.",
    highlights: [
      "Five Built-ins: Default, Paper (serif), Terminal (mono + scanlines), Midnight (gradient + glass), and Aurora (vivid gradient).",
      "Full Looks: Themes change the chat background, bubbles, and font together — not just a hue swap.",
      "Community Themes: New looks ship through cairn-community and appear on the next catalog refresh.",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Safe by Default: File edits are confined to your working folder, and the on-device local model routes through the same engine.",
    ],
  },
];
