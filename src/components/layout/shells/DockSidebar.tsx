    ...
    <>
      ...
      >
        ...
        <div aria-hidden={!collapsed} inert={!collapsed ? true : undefined} className={cn("flex flex-col items-center gap-1 w-full flex-1 min-h-0 transition-opacity duration-300", collapsed ? "opacity-100" : "opacity-0 pointer-events-none absolute inset-x-0 top-3")}>
          ...
          <div className="w-5 h-px bg-[var(--border)] my-1" />
          <Tooltip content={`Overview (${shortcutMap.get("overview") ?? ""})`} side="right"><button aria-label="Overview" onClick={() => setView("overview")} className={cn("p-2 rounded-md", activeView === "overview" ? "text-[var(--accent)] bg-[var(--accent-dim)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><Hash size={15} /></button></Tooltip>
          <Tooltip content={`Notes (${shortcutMap.get("notes") ?? ""})`} side="right"><button aria-label="Notes" onClick={() => setView("notes")} className={cn("p-2 rounded-md", activeView === "notes" ? "text-[var(--accent)] bg-[var(--accent-dim)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><FileText size={15} /></button></Tooltip>
          {!hiddenViews.has("board") && <Tooltip content={`Board (${shortcutMap.get("board") ?? ""})`} side="right"><button aria-label="Board" onClick={() => setView("board")} className={cn("p-2 rounded-md", activeView === "board" ? "text-[var(--accent)] bg-[var(--accent-dim)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><Kanban size={15} /></button></Tooltip>}
          {!hiddenViews.has("calendar") && <Tooltip content={`Calendar (${shortcutMap.get("calendar") ?? ""})`} side="right"><button aria-label="Calendar" onClick={() => setView("calendar")} className={cn("p-2 rounded-md", activeView === "calendar" ? "text-[var(--accent)] bg-[var(--accent-dim)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><CalendarDays size={15} /></button></Tooltip>}
          {!hiddenViews.has("flow") && <Tooltip content={`Flow (${shortcutMap.get("flow") ?? ""})`} side="right"><button aria-label="Flow" onClick={() => setView("flow")} className={cn("p-2 rounded-md", activeView === "flow" ? "text-[var(--accent)] bg-[var(--accent-dim)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><Workflow size={15} /></button></Tooltip>}
          {!hiddenViews.has("agent") && <Tooltip content={`Agent (${shortcutMap.get("agent") ?? ""})`} side="right"><button aria-label="Agent" onClick={() => setView("agent")} className={cn("p-2 rounded-md", activeView === "agent" ? "text-[var(--accent)] bg-[var(--accent-dim)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><Terminal size={15} /></button></Tooltip>}
          <div className="flex-1" aria-hidden="true" />
          <div className="mt-auto w-full flex flex-col items-center gap-1 pt-2 border-t border-[var(--border)]">
            <Tooltip content="Automations" side="right"><button aria-label="Automations" onClick={() => setView("automations")} className={cn("p-2 rounded-md", activeView === "automations" ? "text-[var(--accent)] bg-[var(--accent-dim)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><Zap size={15} /></button></Tooltip>
            <Tooltip content="Calendar" side="right"><button aria-label="Calendar" onClick={() => setView("calendar-all")} className={cn("p-2 rounded-md", activeView === "calendar-all" ? "text-[var(--accent)] bg-[var(--accent-dim)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><CalendarDays size={15} /></button></Tooltip>
            {!hiddenViews.has("graph") && <Tooltip content="Knowledge Graph" side="right"><button aria-label="Knowledge Graph" onClick={() => setView("graph")} className={cn("p-2 rounded-md", activeView === "graph" ? "text-[var(--accent)] bg-[var(--accent-dim)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><GitBranch size={15} /></button></Tooltip>}
            {!hiddenViews.has("insights") && <Tooltip content="Insights" side="right"><button aria-label="Insights" onClick={() => setView("insights")} className={cn("p-2 rounded-md", activeView === "insights" ? "text-[var(--accent)] bg-[var(--accent-dim)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><BarChart2 size={15} /></button></Tooltip>}
            {!hiddenViews.has("usage") && <Tooltip content="Usage" side="right"><button aria-label="Usage" onClick={() => setView("usage")} className={cn("p-2 rounded-md", activeView === "usage" ? "text-[var(--accent)] bg-[var(--accent-dim)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><Activity size={15} /></button></Tooltip>}
            ...
            <div className="w-5 h-px bg-[var(--border)] my-1" />
            <Tooltip content="Settings" side="right"><button aria-label="Settings" onClick={() => setView("settings")} className={cn("p-2 rounded-md", activeView === "settings" ? "text-[var(--text-primary)] bg-[var(--surface-2)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><Settings size={15} /></button></Tooltip>
          </div>
        </div>
          ...
          <nav className="flex-1 overflow-y-auto py-3 px-2 space-y-4 min-h-0">
            <div>
              ...
              <div className="space-y-0.5">
                ...
                {!hiddenViews.has("board") && <button onClick={() => setView("board")} className={cn("flex items-center gap-2 w-full px-2.5 py-1.5 rounded-md text-xs font-medium", activeView === "board" ? "bg-[var(--accent-dim)] text-[var(--accent)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><Kanban size={13} /> Board<span className="ml-auto text-[0.643rem] font-mono text-[var(--text-tertiary)]">{shortcutMap.get("board")}</span></button>}
                {!hiddenViews.has("calendar") && <button onClick={() => setView("calendar")} className={cn("flex items-center gap-2 w-full px-2.5 py-1.5 rounded-md text-xs font-medium", activeView === "calendar" ? "bg-[var(--accent-dim)] text-[var(--accent)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><CalendarDays size={13} /> Calendar<span className="ml-auto text-[0.643rem] font-mono text-[var(--text-tertiary)]">{shortcutMap.get("calendar")}</span></button>}
                {!hiddenViews.has("flow") && <button onClick={() => setView("flow")} className={cn("flex items-center gap-2 w-full px-2.5 py-1.5 rounded-md text-xs font-medium", activeView === "flow" ? "bg-[var(--accent-dim)] text-[var(--accent)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><Workflow size={13} /> Flow<span className="ml-auto text-[0.643rem] font-mono text-[var(--text-tertiary)]">{shortcutMap.get("flow")}</span></button>}
                {!hiddenViews.has("agent") && <button onClick={() => setView("agent")} className={cn("flex items-center gap-2 w-full px-2.5 py-1.5 rounded-md text-xs font-medium", activeView === "agent" ? "bg-[var(--accent-dim)] text-[var(--accent)]" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]")}><Terminal size={13} /> Agent<span className="ml-auto text-[0.643rem] font-mono text-[var(--text-tertiary)]">{shortcutMap.get("agent")}</span></button>}
              </div>
            </div>
