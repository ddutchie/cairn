...
export function StudioSidebar() {
  const { activeWorkspaceId, activeProjectId, activeView, workspaces, projects: allProjects, getWorkspaceProjects, setActiveProject, setView, cards, hiddenViews, toggleSidebar } =
    useCairnStore(
      useShallow((s) => ({
