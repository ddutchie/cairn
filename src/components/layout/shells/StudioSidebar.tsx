      ...
      <div className="flex-1 overflow-y-auto px-2.5 py-2 space-y-4">
        ...
        <div>
          ...
          <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] overflow-hidden">
            ...
            <div className="p-1 space-y-0.5">
              ...
              <button onClick={() => setView("notes")} className={cn("flex items-center gap-2 w-full px-2 py-1.5 rounded-md text-xs", activeView === "notes" ? "bg-[var(--accent-dim)] text-[var(--accent)]" : "text-[var(--text-tertiary)] hover:bg-[var(--surface-2)] hover:text-[var(--text-secondary)]")}><FileText size={13} /> Notes</button>
              {!hiddenViews.has("board") && <button onClick={() => setView("board")} className={cn("flex items-center gap-2 w-full px-2 py-1.5 rounded-md text-xs", activeView === "board" ? "bg-[var(--accent-dim)] text-[var(--accent)]" : "text-[var(--text-tertiary)] hover:bg-[var(--surface-2)] hover:text-[var(--text-secondary)]")}><Kanban size={13} /> Board</button>}
              {!hiddenViews.has("calendar") && <button onClick={() => setView("calendar")} className={cn("flex items-center gap-2 w-full px-2 py-1.5 rounded-md text-xs", activeView === "calendar" ? "bg-[var(--accent-dim)] text-[var(--accent)]" : "text-[var(--text-tertiary)] hover:bg-[var(--surface-2)] hover:text-[var(--text-secondary)]")}><CalendarDays size={13} /> Calendar</button>}
              {!hiddenViews.has("flow") && <button onClick={() => setView("flow")} className={cn("flex items-center gap-2 w-full px-2 py-1.5 rounded-md text-xs", activeView === "flow" ? "bg-[var(--accent-dim)] text-[var(--accent)]" : "text-[var(--text-tertiary)] hover:bg-[var(--surface-2)] hover:text-[var(--text-secondary)]")}><Workflow size={13} /> Idea Flow</button>}
              {!hiddenViews.has("agent") && <button onClick={() => setView("agent")} className={cn("flex items-center gap-2 w-full px-2 py-1.5 rounded-md text-xs", activeView === "agent" ? "bg-[var(--accent-dim)] text-[var(--accent)]" : "text-[var(--text-tertiary)] hover:bg-[var(--surface-2)] hover:text-[var(--text-secondary)]")}><Terminal size={13} /> Agent</button>}
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] overflow-hidden">
            ...
            <div className="p-1 space-y-0.5">
              <button onClick={() => setView("calendar-all")} className={cn("flex items-center gap-2 w-full px-2 py-1.5 rounded-md text-xs", activeView === "calendar-all" ? "bg-[var(--surface-2)] text-[var(--text-primary)]" : "text-[var(--text-tertiary)] hover:bg-[var(--surface-2)] hover:text-[var(--text-secondary)]")}><CalendarDays size={13} /> Calendar</button>
              {!hiddenViews.has("graph") && <button onClick={() => setView("graph")} className={cn("flex items-center gap-2 w-full px-2 py-1.5 rounded-md text-xs", activeView === "graph" ? "bg-[var(--surface-2)] text-[var(--text-primary)]" : "text-[var(--text-tertiary)] hover:bg-[var(--surface-2)] hover:text-[var(--text-secondary)]")}><GitBranch size={13} /> Knowledge Graph</button>}
              {!hiddenViews.has("insights") && <button onClick={() => setView("insights")} className={cn("flex items-center gap-2 w-full px-2 py-1.5 rounded-md text-xs", activeView === "insights" ? "bg-[var(--surface-2)] text-[var(--text-primary)]" : "text-[var(--text-tertiary)] hover:bg-[var(--surface-2)] hover:text-[var(--text-secondary)]")}><BarChart2 size={13} /> Insights</button>}
              <button onClick={() => setView("automations")} className={cn("flex items-center gap-2 w-full px-2 py-1.5 rounded-md text-xs", activeView === "automations" ? "bg-[var(--surface-2)] text-[var(--text-primary)]" : "text-[var(--text-tertiary)] hover:bg-[var(--surface-2)] hover:text-[var(--text-secondary)]")}><Zap size={13} /> Automations</button>
            </div>
          </div>
        </div>
      </div>
