...
export interface ChatRequest {
  ...
  config?: { baseUrl?: string; model?: string; apiKey?: string; maxSteps?: number; temperature?: number; maxTokens?: number; isReasoningModel?: boolean; reasoningEffort?: "none" | "low" | "high" | "max"; contextLimit?: number; contextWindow?: number };
  systemPrompt?: string;
  /**
