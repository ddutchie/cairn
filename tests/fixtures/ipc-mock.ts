...
(function () {
  ...
  window.electron = {
    ...
    session: {
      ...
      saveMessages:   noop,
      // legacy piAgent channels for backward compat (still subscribed by some hooks)
      ...
      onSubagentToken: makeListener("piAgent.onSubagentToken"),
      onSubagentThought: makeListener("piAgent.onSubagentThought"),
      onSubagentToolCall: makeListener("piAgent.onSubagentToolCall"),
      onSubagentToolCallDone: makeListener("piAgent.onSubagentToolCallDone"),
      onSubagentUsage: makeListener("piAgent.onSubagentUsage"),
      onAskQuestions: makeListener("piAgent.onAskQuestions"),
